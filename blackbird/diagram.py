...
class BlackBirdDiagram(Diagram):
    ...
    * sgnUpdated: whenever the Diagram has been updated in any of its parts.
    ...
    def mousePressEvent(self, mouseEvent):
        ...
        # if mouseButtons & QtCore.Qt.LeftButton:
        #
        #     if self.mode is DiagramMode.NodeAdd:#non c'è NodeAdd
        #
        #         #############################################
        #         # NODE INSERTION
        #         #################################
        ...
        #         node.setPos(snap(mousePos, BlackBirdDiagram.GridSize, snapToGrid))
        #         self.session.undostack.push(CommandNodeAdd(self, node))
        #         self.sgnItemInsertionCompleted.emit(node, mouseEvent.modifiers())
        #
        #     elif self.mode is DiagramMode.EdgeAdd:#non c'è EdgeAdd
        #
        #         #############################################
        #         # EDGE INSERTION
        #         #################################
